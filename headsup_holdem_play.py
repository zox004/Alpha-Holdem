...
def main():
    ...
    class StartPage(Frame):
        def __init__(self, parent, controller):
            ...
            self.entry_p0 = Entry(name_frame, font=("Courier", 12), bd=5)
            self.entry_p0.place(relwidth=1.0, relheight=0.5)
            self.entry_p1 = Entry(name_frame, font=("Courier", 12), bd=5)
            self.entry_p1.place(rely=0.5, relwidth=1, relheight=0.5)
    ...
    class GamePage(Frame):
        def __init__(self, parent, controller):
            ...
            top_frame.place(relx=0, rely=0, relwidth=1, relheight=0.5, anchor='nw')

            self.cc_frame = Frame(top_frame, bd=2, relief="raised")
            self.cc_frame.place(relx=0.5, rely=0.1, relwidth=0.8, relheight=0.6, anchor='n')

            self.cc_1 = Label(self.cc_frame, bg="green")
            self.cc_1.place(relwidth=(.50 / 3), relheight=1)
            card_d1 = ImageTk.PhotoImage(
                Image.open("cards\default0.png").resize((88, 136), Image.ANTIALIAS))
            ...
            card_d2 = ImageTk.PhotoImage(
                Image.open("cards\default1.png").resize((88, 136), Image.ANTIALIAS))
            ...
            self.pot_label = Label(top_frame, bg='green', fg='white', text="pot: ", font=("Courier", 15), bd=3)
            self.pot_label.place(relx=0.5, rely=0.7, relwidth=0.5, relheight=0.08, anchor='n')

            down_frame = Frame(canvas, bg='green', bd=5)
            down_frame.place(relx=0, rely=0.5, relwidth=1, relheight=0.5, anchor='nw')
            name_frame = Frame(down_frame, bg="light green", bd=5)
            name_frame.place(relx=0, rely=0, relwidth=0.5, relheight=1, anchor="nw")

            self.frame_p0 = Frame(name_frame, bd=3, relief="groove")
            self.frame_p0.place(relwidth=0.5, relheight=1)
            self.name_label_p0 = Label(self.frame_p0, font=("Courier", 12), bd=3)
            self.name_label_p0.place(relx=0, rely=0.7, relheight=0.1, relwidth=1)
            self.chips_label_p0 = Label(self.frame_p0, font=("Courier", 12), bd=3)
            self.chips_label_p0.place(relx=0, rely=0.8, relheight=0.1, relwidth=1)
            self.cards_frame_p0 = Frame(self.frame_p0, bd=3, relief="groove")
            self.cards_frame_p0.place(relx=0, relheight=0.7, relwidth=1)
            ...
            self.stake_label_p0 = Label(self.frame_p0, bd=1, font=('Courier', 12), relief="groove")
            self.stake_label_p0.place(relx=0, rely=0.9, relheight=0.1, relwidth=1)

            self.frame_p1 = Frame(name_frame, bd=3, relief="groove")
            self.frame_p1.place(relx=0.5, relwidth=0.5, relheight=1)
            self.name_label_p1 = Label(self.frame_p1, font=("Courier", 12), bd=3)
            self.name_label_p1.place(relx=0, rely=0.7, relheight=0.1, relwidth=1)
            self.chips_label_p1 = Label(self.frame_p1, font=("Courier", 12), bd=3)
            self.chips_label_p1.place(relx=0, rely=0.8, relheight=0.1, relwidth=1)
            self.cards_frame_p1 = Frame(self.frame_p1, bd=3, relief="groove")
            self.cards_frame_p1.place(relx=0, relheight=0.7, relwidth=1)
            ...
            self.stake_label_p1 = Label(self.frame_p1, bd=1, font=('Courier', 12), relief="groove")
            self.stake_label_p1.place(relx=0, rely=0.9, relheight=0.1, relwidth=1)


            self.action_frame = Frame(down_frame, bd=2, relief="raised", bg="green")
            self.action_frame.place(relx=0.5, rely=0, relwidth=0.5, relheight=1, anchor='nw')
        ...
        def update(self, game):
            ...
            if self.restart:
                card1 = ImageTk.PhotoImage(Image.open(str("cards\default0.png")).resize((88, 136), Image.ANTIALIAS))
            ...
            try:
                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.cards[0]) + ".png").resize((88, 136), Image.ANTIALIAS))
                self.cc_1.image = card1
                self.cc_1.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.cards[1]) + ".png").resize((88, 136), Image.ANTIALIAS))
                self.cc_2.image = card1
                self.cc_2.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.cards[2]) + ".png").resize((88, 136), Image.ANTIALIAS))
                self.cc_3.image = card1
                self.cc_3.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.cards[3]) + ".png").resize((88, 136), Image.ANTIALIAS))
                self.cc_4.image = card1
                self.cc_4.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.cards[4]) + ".png").resize((88, 136), Image.ANTIALIAS))
                self.cc_5.image = card1
                self.cc_5.configure(image=card1)
            except IndexError:
                pass
            try:
                ...
                pass
            try:
                self.chips_label_p0["text"] = "Chips: " + str(game.list_of_players[0].chips)
                self.chips_label_p1["text"] = "Chips: " + str(game.list_of_players[1].chips)
            except IndexError:
                pass
            try:
                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[0].cards[0]) + ".png").resize((88, 136), Image.ANTIALIAS))
                self.card1_p0.image = card1
                self.card1_p0.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[1].cards[0]) + ".png").resize((88, 136), Image.ANTIALIAS))
            ...
            try:
                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[0].cards[1]) + ".png").resize((88, 136), Image.ANTIALIAS))
                self.card2_p0.image = card2
                self.card2_p0.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[1].cards[1]) + ".png").resize((88, 136), Image.ANTIALIAS))
                self.card2_p1.image = card2
                self.card2_p1.configure(image=card2)
            except IndexError:
                pass
            try:
                self.stake_label_p0["text"] = "Bet: " + str(game.list_of_players[0].stake)
                self.stake_label_p1["text"] = "Bet: " + str(game.list_of_players[1].stake)
            except IndexError:
                pass
